...
export default function Sobremim() {
  return (
    <PostModelo fotoCapa={fotoCapa}>
      <h3 className={styles.subtitulo}>Olá, meu nome é Antonio!</h3>
      ...
      <p>
        ...
        ver por aqui. Minha história com programação começou no Instituto
        Federal do Piauí (IFPI), quando fiz o ensino médio integrado ao curso de
        Informática. Eu aprendi lógica de programação e o básico de várias
        linguagens, como PHP, Python, Java, mas sem aprofundar muito em cada uma
        ...
        cursar Engenharia Elétrica na Universidade Federal do Piauí (UFPI). Lá
        eu consegui entrar no PET (Programa de Educação Tutorial), um grupo
        ...
        do site deles. No ensino superior, escolhi cursar Engenharia Elétrica na
